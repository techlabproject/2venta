...
function GoogleMark() {
  return (
    <svg viewBox="0 0 48 48" className="h-4 w-4" aria-hidden="true">
      ...
      <path fill="#34A853" d="M24 46c5.9 0 10.8-1.9 14.4-5.2l-6.9-5.3c-1.8 1.3-4.3 2.2-7.5 2.2-5.7 0-10.6-3.8-12.3-9l-7.1 5.5C8.3 41.1 15.6 46 24 46z" />
      <path fill="#FBBC05" d="M11.7 28.7c-.5-1.3-.7-2.7-.7-4.2s.3-2.9.7-4.2l-7.1-5.5C3.1 17.6 2.3 20.7 2.3 24s.8 6.4 2.3 9.2l7.1-4.5z" />
      <path fill="#EA4335" d="M24 10.7c4 0 6.8 1.7 8.4 3.2l6.1-6C34.7 4.4 29.9 2 24 2 15.6 2 8.3 6.9 4.6 14.8l7.1 5.5c1.7-5.2 6.6-9.6 12.3-9.6z" />
    </svg>
  );
}
