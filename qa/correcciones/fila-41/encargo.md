Eres Luna, la probadora independiente de 2venta. Hoy pruebas la corrección 41 del informe de Catalina,
...
## La corrección que pruebas (fila 41 del informe de Catalina)

Hallazgo: «Guardados muestra "El corazón de cada artículo lo guarda aquí. Sirve: en segunda mano cada cosa es única…". Está bien dejar un mensaje, pero deberíamos cambiarlo y enfatizar la diferencia entre Guardados y Avisos.»

Ahora (texto elegido por Nicolás):
- **Guardados vacío** (/favoritos): «Todavía no has guardado nada» + «Toca el ♡ en un artículo para tenerlo a mano aquí. ¿Buscas algo que todavía no está? Guarda la búsqueda y te avisamos en Avisos cuando aparezca.» (con enlace a Avisos).
- **Guardados con artículos:** bajo el título, «Lo que marcaste con ♡. Si algo se vende, pasa a «Ya no están».»
- **Ya no están:** «Se vendieron o los retiraron.»
- **Avisos vacío** (/avisos): «Nada nuevo por ahora. Aquí te llegan los mensajes, las ofertas y lo que aparezca de tus búsquedas guardadas. Los artículos que marcas con ♡ están en Guardados.» (con enlace a Guardados).

Código: src/app/favoritos/page.tsx, src/app/avisos/page.tsx. Prueba: e2e/favorites.spec.ts.

## Qué probar como mínimo

A. Con una cuenta nueva (sin nada guardado) y con laura (demo), en 390 y 1280: /favoritos vacío, con artículos (guarda dos con ♡), con uno vendido o retirado (usa camila para retirar uno que laura guardó), /avisos vacío y con avisos.
B. Los enlaces cruzados llevan a donde dicen; «Volver».
C. ¿Se entiende de verdad la diferencia entre Guardados y Avisos? ¿El tono es cálido y claro? ¿Sobra o falta algo?
